...
Since the requirement of this assignment is to determine the end pose of the robot two points marked by the pens would be used to calculate the position of the robot as well as its orientation.
