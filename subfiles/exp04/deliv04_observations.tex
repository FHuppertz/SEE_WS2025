...
From the conducted calibration, it was observed that capturing images from diverse angles and maintaining uniform lighting significantly improved corner detection accuracy and reduced overall reprojection error. 
